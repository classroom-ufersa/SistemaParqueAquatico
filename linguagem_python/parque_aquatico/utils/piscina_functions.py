...
def listar_piscinas():
    ...
    if arquivoVazio('linguagem_python/parque_aquatico/piscina/piscinas.txt'):
    ...
    if st.button("Deletar piscina"):
        if validInteger(identificacao) == False:
            ...
            if (identificacao not in identificacoes) or (int(identificacao) < 0) or (identificacao == ""):
                ...
                arquivo = open('linguagem_python/parque_aquatico/piscina/piscinas.txt', 'w', encoding= 'latin-1')
